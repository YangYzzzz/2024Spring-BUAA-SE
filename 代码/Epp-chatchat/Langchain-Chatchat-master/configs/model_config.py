...
MODEL_ROOT_PATH = "/home/se1/.cache/huggingface/hub/"

# 选用的 Embedding 名称
EMBEDDING_MODEL = "bge-large-zh-v1.5"

# Embedding 模型运行设备。设为 "auto" 会自动检测(会有警告)，也可手动设定为 "cuda","mps","cpu","xpu" 其中之一。
EMBEDDING_DEVICE = "cuda:2"  # 配置GPU位置
...
MODEL_PATH = {
    "embed_model": {
        ...
        "bge-large-zh": "models--BAAI--bge-large-zh/snapshots/b5d9f5c027e87b6f0b6fa4b614f8f9cdc45ce0e8",
    ...
    "llm_model": {
        ...
        "chatglm3-6b": "models--THUDM--chatglm3-6b/snapshots/103caa40027ebfd8450289ca2f278eac4ff26405",
